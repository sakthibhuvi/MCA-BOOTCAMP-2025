...
*/
	let n =parseInt(window.prompt("how many number u want to enter"));
    let num=[];
    for(let i=0;i<n;i++){
        num.push(Number(window.prompt("enter the number " + (i+1))))
    }
    let small=Math.min(...num);
    console.log("the smallest numbeer is " + small);
